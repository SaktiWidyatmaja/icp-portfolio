...
// Type '({ experienceId: string; position: string; startTime: bigint; endTime: bigint; description: string; } & { _azleCandidType?: "_azleCandidType" | undefined; })[]' is not assignable to 
// type '{ portfolioId: string; education: { degree: string; school: string; graduationYear: number; } & { _azleCandidType?: "_azleCandidType" | undefined; }; experiences: ({ experienceId: string; position: string; startTime: bigint; endTime: bigint; description: string; } & { ...; })[]; projects: ({ ...; } & { ...; })[]; cr...'.
// Type '({ experienceId: string; position: string; startTime: bigint; endTime: bigint; description: string; } & { _azleCandidType?: "_azleCandidType" | undefined; })[]' is missing the following properties from type '{ portfolioId: string; education: { degree: string; school: string; graduationYear: number; } & { _azleCandidType?: "_azleCandidType" | undefined; }; experiences: ({ experienceId: string; position: string; startTime: bigint; endTime: bigint; description: string; } & { ...; })[]; projects: ({ ...; } & { ...; })[]; cr...': portfolioId, education, experiences, projects, and 2 more.ts(2322)
